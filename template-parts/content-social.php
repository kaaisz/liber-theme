        <div class="share">
			...
			<div class="share__container">
				<a class="share__button" href="//twitter.com/share?text=<?php the_title();?>〜<?php the_field('article_sub_title'); ?>〜 | リベル&url=http://liber.community" onclick="javascript:window.open(this.href, '_blank', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=400,width=600');return false;">
				...
				<a class="share__button" href="//www.facebook.com/sharer.php?src=bm&u=http://liber.community&t=<?php the_title();?>〜<?php the_field('article_sub_title'); ?>〜 | リベル" onclick="javascript:window.open(this.href, '_blank', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=800,width=600');return false;">
				...
				<a class="share__button" href="//line.me/R/msg/text/?<?=the_title().'%0A'.the_field('article_sub_title');?>" target="_blank">
